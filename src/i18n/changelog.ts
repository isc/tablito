...
const fr: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "Division, division avec reste, conjugaison\u00a0: les derniers faits finissent toujours par être introduits. Dans ces trois matières, une poignée de faits — souvent une douzaine — pouvait rester « pas encore introduite » pendant des semaines alors que tout le reste était déjà en boîte 4 ou 5. En cause, une règle de prudence du début de parcours\u00a0: tant qu'un fait déjà vu est retombé en boîte 1, aucun nouveau fait n'est introduit. Sur une cinquantaine de faits, elle revenait à exiger une séance sans la moindre erreur pour avancer d'un cran — ce qui n'arrive presque jamais. La levée de fin de parcours existait déjà pour les tables, mais avait été calibrée pour leurs 36 faits seulement\u00a0; elle couvre désormais le dernier cinquième de chaque matière, soit les 12 derniers faits en division, en division avec reste et en conjugaison.",
    ],
  },
  {
    date: '2026-09-07',
...
const en: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      "Division, division with remainders, conjugation: the last few facts now always get introduced. In those three subjects, a handful of facts — often a dozen — could stay \"not introduced yet\" for weeks while everything else was already in box 4 or 5. The cause was an early-days safety rule: as long as one already-seen fact has dropped back to box 1, no new fact is introduced. Across fifty-odd facts, that amounted to requiring a flawless session to move forward at all — which almost never happens. The end-of-course exemption already existed for the times tables, but had been calibrated for their 36 facts only; it now covers the last fifth of each subject, that is the last 12 facts in division, division with remainders and conjugation.",
    ],
  },
  {
    date: '2026-09-07',
